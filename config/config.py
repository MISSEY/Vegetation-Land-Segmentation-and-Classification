...
train_config = {
    ...
    "model_name" : 'R_101_FPN', # R_101_X_FPN, R_101_FPN, R_50_FPN
    ...
    "config_file" : "COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml", # mask_rcnn_X_101_32x8d_FPN_3x , mask_rcnn_R_101_FPN_3x , mask_rcnn_R_50_FPN_3x
    "batch_size" : 2048,
