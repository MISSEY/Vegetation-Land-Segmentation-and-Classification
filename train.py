...
def register_data_set():
    train_path = os.path.join(settings.data_directory_cluster, config._version_name,config.train_image_size,config._version_train_)
    validation_path = os.path.join(settings.data_directory_cluster, config._version_name,config.train_image_size,config._version_validation_)
