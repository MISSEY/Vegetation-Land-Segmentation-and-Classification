...
class coco(IMDB):
    def __init__(self, image_set, root_path, data_path, versionandyear, result_path=None, mask_size=-1, binary_thresh=None):
        """
        ...
        self.versionandyear = versionandyear
    ...
    def image_path_from_index(self, index):
        ...
        filename = 'COCO_%s_%s_%012d.jpg' % (self.data_name,self.versionandyear, index)
