...
def load_gt_sdsdb(dataset_name, image_set_name, root_path, dataset_path, versionandyear,
                  result_path=None, flip=False, mask_size=21, binary_thresh=0.4):
    """ load ground truth sdsdb """
    imdb = eval(dataset_name)(image_set_name, root_path, dataset_path, versionandyear, result_path,
